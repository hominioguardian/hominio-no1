...
>
  ...
  <div class="max-w-5xl mx-auto relative z-10">
    ...
    <div class="max-w-4xl mx-auto">
      <!-- Step 1: Record -->
      <div
        class="bg-white rounded-2xl p-8 mb-8 shadow-xl border-l-8 border-yellow-400"
      >
        <div class="flex items-start space-x-6">
          <div class="flex-shrink-0">
            <div
              class="w-16 h-16 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full flex items-center justify-center text-white font-bold text-xl shadow-lg"
            >
              📱
            </div>
          </div>
          <div class="flex-1">
            ...
            >
              ...
              <div
                class="mt-4 p-4 bg-yellow-100 rounded-lg border border-yellow-300"
              >
                <p class="text-lg font-medium text-yellow-800 text-center">
                  ——— Fill in the blanks ———
                </p>
              </div>
            </div>
      ...
      <!-- Step 3: Submit -->
      <div
        class="bg-gradient-to-r from-blue-900 to-slate-800 rounded-2xl p-8 shadow-xl text-white"
      >
        <div class="text-center">
          ...
          <h3 class="text-2xl font-semibold mb-4">When you reach 100 likes</h3>
          ...
          <div class="max-w-md mx-auto">
            ...
            <p class="text-sm opacity-75 mt-3">Link to submission form</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="text-center mt-16">
      <p class="text-2xl md:text-3xl font-light text-slate-700 italic">
        Your vision is waiting.
        <span class="text-blue-900 font-medium">The world is ready.</span>
      </p>
    </div>
  </div>
</section>
